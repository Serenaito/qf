...
void CubismMotion::Parse(const csmByte* motionJson, const csmSizeInt size)
{
    ...
    _motionData->Segments.UpdateSize(json->GetMotionTotalSegmentCount()*1.5, CubismMotionSegment(), true);
    _motionData->Points.UpdateSize(json->GetMotionTotalPointCount()*1.5, CubismMotionPoint(), true);
